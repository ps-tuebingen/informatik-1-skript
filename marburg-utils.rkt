...
(provide inbox-style block ev ex vdash stdeval bsl-eval isl-eval+ isl-eval asl-eval todo step multistep equiv prime e e0 e1 e2 e3 e4 eN-1 eN v v1 v2 v3 vN-1 vN x x1 x2 x3 xI xN-1 xN xN eI vI eI-1 eI+1)
...
(void (interaction-eval #:eval stdeval (require 2htdp/abstraction)))
...
(define-syntax-rule
  ...
  (let ()
    ...
    (interaction-eval #:eval me (require 2htdp/abstraction))
