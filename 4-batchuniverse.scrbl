...
@itemize[#:style 'ordered
       ...
       @item{ein Mausevent (eine Maustaste wurde an der Stelle (123,456) gedrückt)}]
...
Da Event Handler nur Funktionen sind, kann man das letzte Resultat auch durch die @italic{Funktionskomposition} der Event Handler berechnen:
